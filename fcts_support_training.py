...
class train_distribs:
    ...
    def func_boundaries_params( distrib ):
        # put in there constraints on parameters of conditional distribution that are not by default in "distrib_cov". Here, GEV (shape<0) is avoided for physical reasons.
        if distrib == 'GEV':
...
class tree_results_fit:
    ...
    # INITIALIZATION
    # --------------------
    def __init__(self, results_fit, do_empty_nodes=True):
    ...
    def plot(
        ...
        sizes={"dots": 15, "Configuration": 14, "distrib": 12, "expression": 7, "BIC": 9},
    ):
        """
        Plot the tree
